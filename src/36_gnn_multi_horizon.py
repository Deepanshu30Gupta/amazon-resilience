...
Output: data/processed/gnn_multi_horizon_results.csv
"""
...
def main():
    ...
    results_df.to_csv(os.path.join(OUT_DIR, "gnn_multi_horizon_results.csv"), index=False)
